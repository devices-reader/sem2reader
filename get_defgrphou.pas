...
uses kernel;
procedure BoxGetDefGrpHou;
procedure ShowGetDefGrpHou;
...
const
  quGetDefGrpHou: querys = (Action: acGetDefGrpHou; cwOut: 7+6; cwIn: 0; bNumber: $FF;);
...
procedure QueryGetDefGrpHou;
begin
  InitPushCRC;
  Push(91);
  Push(ibDay);
  if PushGrpMask then Query(quGetDefGrpHou);
end;
